""" 
XPM module contains the code to process xpm files, including ges information from xpm, visualization and data convertion. 
"""
...
def main():
    ...
    if extract_file != None:
        xpm = XPM(extract_file)
        xpm.xpm2csv(output)

    if gnuplot_file != None:
        xpm = XPM(gnuplot_file)
        xpm.xpm2gpl(output)
