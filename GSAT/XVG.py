...
def ramachandran(xvgfile: str = "") -> None:
    ...
    parameters:
        xvgfile: a xvg file contains phi and psi data which generated by gmx rama
    """
        ...
        with open(val["file"]) as fn:
            for line in fn:
                if line.startswith("#"):
                    ...
                    RAMA_PREF_VALUES[key][x + 180][y + 180] = RAMA_PREF_VALUES[key][
                        x + 179
                    ][y + 179] = RAMA_PREF_VALUES[key][x + 179][
                        y + 180
                    ] = RAMA_PREF_VALUES[
                        key
                    ][
    ...
    for idx, (key, val) in enumerate(
        ...
        plt.scatter(normals[key]["x"], normals[key]["y"], s=8)
        plt.scatter(outliers[key]["x"], outliers[key]["y"], s=8)
        plt.xlim([-180, 180])
        plt.ylim([-180, 180])
